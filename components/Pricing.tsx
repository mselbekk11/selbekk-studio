        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 w-full'>
          <div className='border-2 border-[#000]'>
            ...
            <div className='p-6'>
              <div className='flex items-center w-full pb-2'>
                ...
                <p className='text-md leading-8 text-black'>Custom Design</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Development</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
              ...
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>CMS integration</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Deployment</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>
              ...
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>24 hour support</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>
              ...
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Contact form</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>
                  Custom illustrations
                </p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>Logo</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>
              ...
              <div className='flex items-center w-full pb-2'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>Customer Portal</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>
              ...
              <div className='flex items-center w-full pb-6'>
                <CirclePlus color='#ccc' size={20} className='mr-2 rotate-45' />
                <p className='text-md leading-8 text-[#ccc]'>Custom Fonts</p>
              </div>
          ...
          <div className='border-2 border-[#000]'>
            ...
            <div className='p-6'>
              ...
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Logo</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Branding Package</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>
              ...
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Customer Portal</p>
              </div>
              <div className='flex items-center w-full pb-2'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Recieve Payments</p>
              </div>
              <div className='flex items-center w-full pb-6'>
                <CheckCircle2 color='#000' size={20} className='mr-2' />
                <p className='text-md leading-8 text-black'>Custom Fonts</p>
              </div>
